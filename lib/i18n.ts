...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    admin: {
      ...
      resetConfirm: "Reset the catalogue to the original fragrances? Your changes will be lost.", localNote: "Changes are shared through the site catalogue so customers on other devices can see updates after refresh.",
  ...
  ar: {
    ...
    admin: {
      ...
      resetConfirm: "إعادة الكتالوج إلى العطور الأصلية؟ ستفقد تغييراتك.", localNote: "تُشارك التغييرات عبر كتالوج الموقع ليتمكن العملاء على الأجهزة الأخرى من رؤيتها بعد التحديث.",
