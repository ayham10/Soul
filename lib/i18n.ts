...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    admin: {
      ...
      description: "Description (EN)", descriptionAr: "Description (AR)", price: "Price (50ml, USD)", image: "Image URL / path", accent: "Accent color",
      ...
      resetConfirm: "Reset the catalogue to the original fragrances? Your changes will be lost.", localNote: "Changes are saved in this browser (demo mode). Connect a database for shared, permanent storage.",
  ...
  ar: {
    ...
    admin: {
      ...
      description: "الوصف (إنجليزي)", descriptionAr: "الوصف (عربي)", price: "السعر (٥٠مل، دولار)", image: "رابط/مسار الصورة", accent: "اللون المميّز",
      ...
      resetConfirm: "إعادة الكتالوج إلى العطور الأصلية؟ ستفقد تغييراتك.", localNote: "تُحفظ التغييرات في هذا المتصفّح (وضع تجريبي). اربط قاعدة بيانات للتخزين الدائم والمشترك.",
