...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    admin: {
      ...
      resetConfirm: "Reset the catalogue to the original fragrances? Your changes will be lost.", localNote: "For all customers to see admin edits, configure Upstash Redis / Vercel KV environment variables on the deployed site.",
  ...
  ar: {
    ...
    admin: {
      ...
      resetConfirm: "إعادة الكتالوج إلى العطور الأصلية؟ ستفقد تغييراتك.", localNote: "لكي يرى كل العملاء تعديلات الإدارة، يجب ضبط متغيرات Upstash Redis / Vercel KV في الموقع المنشور.",
